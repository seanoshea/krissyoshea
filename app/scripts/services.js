...
angular.module('krissyosheaApp.services', []).factory('portfolioService', function($rootScope, $http) {
    return {
        ...
        getPortfolio: function(portfolioId) {
            var self = this;
            $http.jsonp('https://api.flickr.com/services/rest/?method=flickr.photosets.getPhotos&extras=url_m,url_o&photoset_id=' + portfolioId + '&api_key=3426649638b25fe317be122d3fbbc1b1&format=json&jsoncallback=JSON_CALLBACK').success(function(data) {
